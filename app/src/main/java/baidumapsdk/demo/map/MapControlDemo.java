...
import baidumapsdk.demo.DrawView;
...
public class MapControlDemo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        drawView = (DrawView) findViewById(R.id.dw_view);
    ...
    private void initListener() {
        ...
        cb_draw.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!cb_draw.isChecked()) {
                    drawView.setVisibility(View.GONE);
                    List<PointF> path = drawView.getScreenPath();
                    ...
                    for (PointF p:path) {
                        ...
                        pts.add(pt);
                        Log.i("Turman",pt.latitude+","+pt.longitude);
                    }
